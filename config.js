...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Church Street Plumbing & Sheet Metal Works",
    phone:     "",
    whatsapp:  "",
    address:   "St Domingo Ave, Johannesburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Church Street Plumbing & Sheet Metal Works — Services in johannesburg",
    description: "Church Street Plumbing & Sheet Metal Works provides professional services in Johannesburg. 1 Google review. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Services · Johannesburg & surrounds",
    heroTitle:  "Professional service — <em>done right.</em>",
    heroLead:   "Church Street Plumbing & Sheet Metal Works provides professional services for homes and businesses across Johannesburg and the surrounding area. Reliable, experienced and locally based.",
    ...
    band: {
      ...
      alt:   "Church Street Plumbing & Sheet Metal Works team at work in Johannesburg",
      text:  "Professional service — reliable, experienced and locally based."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Johannesburg. Serving the wider area.",
    areasLead:  "We work across Johannesburg CBD, Parktown, Melville and surrounding suburbs for residential and commercial clients.",
